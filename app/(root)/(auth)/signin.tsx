...
export default function SignIn() {
  ...
  const { signInWith, status: socialStatus, signingIn: socialSigning } = useSocialSignin();
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView className="h-full">
          <View>
            ...
            <Text className="text-primary mx-4 my-2 text-left text-5xl font-extrabold">
              {'Welcome back'}
            </Text>
            <Text className="text-md text-secondary mx-4 mb-10 text-left text-lg">
              ...
              <View className="items-center">
                {signingIn ? (
                  <View className="flex-row items-center gap-2">
                    ...
                    <Text className="text-primary text-sm font-semibold">{'Signing in...'}</Text>
                  </View>
                ) : (
            ...
            <View className="flex-row justify-between gap-2 px-4 py-3">
              <TouchableOpacity
                className={`android:elevation-2 bg-secondary flex-grow flex-row items-center justify-center rounded-xl py-3 shadow-sm shadow-black/5 ${socialStatus === 'launching' ? 'opacity-50' : ''}`}
          ...
          <View className="mt-10 flex-row justify-center">
            ...
            <TouchableOpacity
              ...
              <Text className="text-secondary text-sm font-semibold underline">{'Sign up'}</Text>
            </TouchableOpacity>
