...
export default function Index() {
  ...
  const toggleCompletion = useMutation(api.tasks.toggleTaskCompletion).withOptimisticUpdate(
    (localStore, args) => {
      ...
      <ScrollView
        ...
        <View className="flex flex-col gap-12">
          ...
          <View>
            ...
            {todayTasks && (
              <TaskItems
                onTaskStatusToggle={(taskId, completed) => toggleCompletion({ taskId, completed })}
