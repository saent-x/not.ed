...
export default function SignUp() {
  ...
  return (
    <SafeAreaView className="bg-background h-full">
      <View className="mx-4 my-5 mt-12 mb-10 items-start">
        <Ionicons
          className="my-5"
          name="person-add"
          size={46}
          color="#cc9469"
        />
        <Text className="mt-4 my-2 text-5xl font-extrabold text-primary">
          Create Account
        </Text>
        <Text className="mt-2 text-left text-lg text-secondary">
